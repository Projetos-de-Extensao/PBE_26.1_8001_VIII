# Generated by Django 6.0.5 on 2026-06-11 19:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acao', models.CharField(choices=[('CRIACAO', 'Criação'), ('ATUALIZACAO', 'Atualização'), ('STATUS', 'Mudança de Status'), ('PENDENCIA', 'Pendência')], max_length=20)),
